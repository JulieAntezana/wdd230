...
const apiURL =
"https://api.openweathermap.org/data/2.5/weather?id=3451190&units=imperial&APPID=80f719b77880789a35971f1d4b25e585";
...
fetch(apiURL)
  ...
  .then((jsObject) => {
    ...
    document.querySelector(".current-temp").textContent = `${todaysTemp}°F`;
